package com.techcos.imagecompressor;
...
public class MainActivity extends AppCompatActivity {
    ...
    File path = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/Image Compressor(TechCos)");
...
//                BitmapFactory.decodeFile(imageUri.getPath().replace("raw/",""),bitmapOptions);
//                txtWidth.setText(imgOriginal.getWidth());
//                txtHeight.setText(imgOriginal.getHeight());
    ...
    private void initViewByIds() {
        imgOriginal = findViewById(R.id.imgOrg);
        imgCompressed = findViewById(R.id.imgCmp);
        txtCompressed = findViewById(R.id.textCmp);
        txtOriginal = findViewById(R.id.textOrg);
        txtQuality = findViewById(R.id.textQuality);
    ...
    private void askPermission() {
        Dexter.withContext(this).withPermissions(Manifest.permission.READ_EXTERNAL_STORAGE,Manifest.permission.WRITE_EXTERNAL_STORAGE,Manifest.permission.MANAGE_EXTERNAL_STORAGE)
